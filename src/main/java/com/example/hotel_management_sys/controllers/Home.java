...
import com.example.hotel_management_sys.entities.*;
import com.example.hotel_management_sys.services.*;
...
public class Home {
    ...
    public  String getMealPage(HttpSession session,Model model)
    {
        ...
        model.addAttribute("products",products);
        return "tmp01/views/meal";
    }

    @RequestMapping(path = "/login")
    public  String getLoginPage(HttpSession session)
    {
        return "tmp01/views/login";
    }
